...
import (
	...
	"git.oneapi-project.net/Personal_Stuff/restAPI/controllers"
	"git.oneapi-project.net/Personal_Stuff/restAPI/database"
	"git.oneapi-project.net/Personal_Stuff/restAPI/model"
